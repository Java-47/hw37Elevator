...
public class TruckElevatorAppl {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// [ [lenin,stalin], [stalin, lenin] ...]
		for (int i = 0; i < trucks.length; i++) {
			trucks[i] = i % 2 == 0 ? new Truck(N_RACES, CAPACITY, lenin, stalin)
					: new Truck(N_RACES, CAPACITY, stalin, lenin);
		...
		System.out.println("Elevator " + stalin.getName() + " have " + stalin.getCurrentVolume() + " tonn");
